    ...
    <div className="flex items-center justify-between border-t border-gray-200 px-3 py-4 sm:px-6">
      ...
      <div className="flex sm:hidden justify-between w-full">
         <button
            onClick={() => onPageChange(currentPage - 1)}
            disabled={currentPage === 1}
            className="relative inline-flex items-center rounded-md px-4 py-2 text-sm font-medium text-[#2f153c] hover:bg-[#FFE8CD]/50 disabled:text-gray-300 disabled:cursor-not-allowed"
          >
            Previous
          </button>
          <button
